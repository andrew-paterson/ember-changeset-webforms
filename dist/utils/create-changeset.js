...
function createChangeset(formFields, data, customValidators, opts = {}) {
  data = data || {};
  var validationsMap = createValidations(formFields, customValidators);
  var changeset = Changeset(data, lookupValidator(validationsMap), validationsMap, {
    skipValidate: true
  });
  formFields.forEach(formField => {
    ...
    if (Object.prototype.hasOwnProperty.call(formField, 'defaultValue') && !opts.suppressDefaults) {
...
//# sourceMappingURL=create-changeset.js.map
