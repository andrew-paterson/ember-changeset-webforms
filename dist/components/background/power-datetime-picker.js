...
class PowerDatetimePicker extends Component {
  ...
  #defaultTime = (i(this, "defaultTime"), void 0);
  static {
    g(this.prototype, "fixedTime", [tracked]);
  }
  #fixedTime = (i(this, "fixedTime"), void 0);
  static {
    g(this.prototype, "dateTimeFormat", [tracked]);
  }
  #dateTimeFormat = (i(this, "dateTimeFormat"), void 0);
  static {
    g(this.prototype, "dateTimeDisplayFormat", [tracked]);
  }
  #dateTimeDisplayFormat = (i(this, "dateTimeDisplayFormat"), void 0);
  static {
    g(this.prototype, "timeSelectorFields", [tracked]);
  }
  #timeSelectorFields = (i(this, "timeSelectorFields"), void 0);
  get defaultHour() {
  ...
  validMoment(event) {
    ...
    const strictDateFormat = parsedDateTimeDisplayFormat.replace(/S{1,}/, 'SSSS'); // Using SSSS for the milisecond part of the format means that the input will be a valid moment object if the user enters more than 3 digits. The field will remove all but the first three.
