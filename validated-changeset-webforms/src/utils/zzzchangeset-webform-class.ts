...
import type { ChangesetWebformProps } from './types.js';

function setCwfProps(instance, data = undefined, opts = {}) {
...
export default class ChangesetWebform implements ChangesetWebformProps {
  // @tracked changeset;
  // @tracked fields;
  formSchema: ChangesetWebformProps['formSchema'];
  formSchemaWithDefaults: ChangesetWebformProps['formSchemaWithDefaults'];
  debug: ChangesetWebformProps['debug'];
  ...
  fields: ChangesetWebformProps['fields'];
  submit: ChangesetWebformProps['submit'];
